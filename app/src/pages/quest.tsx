...
const Quests: NextPage = (props) => {
  ...
  return (
    <div>
      ...
      <div className="flex w-3/4 h-full justify-evenly bg-black bg-opacity-50 backdrop-blur-xl rounded drop-shadow-lg text-white m-5 rounded">
        <div className="flex flex-col justify-center items-center">
          <div className="text-xl font-bold">Quest</div>
          <div className="text-lg text-white">{qBank[questionIndex].question}</div>
