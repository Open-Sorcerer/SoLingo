        ...
        <div className="w-full flex flex-col justify-center items-start">
          ...
          >
            <input
              ...
              placeholder="Title"
              className={
                "w-full flex flex-col justify-center items-start bg-transparent border border-gray-300 rounded-t-lg px-5 py-1"
              }
            />
            <textarea
              id="description"
              ...
              className={
                "w-full flex flex-col justify-center items-start bg-transparent border border-gray-300 py-2 px-5"
              }
            />
            <div className="w-full flex flex-row justify-between items-center bg-transparent border border-gray-300 rounded-b-lg">
              <input
                title="upload"
                type="file"
